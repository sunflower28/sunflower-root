...
public final class Entrypt {
	...
	public static boolean validatePassword(String plainPassword, String password) {
		try {
			...
			byte[] hashPassword = digest(plainPassword.getBytes(StandardCharsets.UTF_8),
					HASH_ALGORITHM, salt, 1024);
			return password.equals(
					Hex.encodeHexString(salt) + Hex.encodeHexString(hashPassword));
		}
