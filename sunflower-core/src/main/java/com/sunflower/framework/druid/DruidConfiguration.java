package com.sunflower.framework.druid;
...
//      datasource.setPasswordCallback(new DruidPassworkCallbackBrc());
    ...
    public ServletRegistrationBean<StatViewServlet> druidServlet() {
        ...
        ServletRegistrationBean<StatViewServlet> servletRegistrationBean = new ServletRegistrationBean(new StatViewServlet(), new String[]{this.statViewServletMapping});
        servletRegistrationBean.addInitParameter("loginUsername", this.statViewServletLoginUsername);
        servletRegistrationBean.addInitParameter("loginPassword", this.statViewServletLoginPassword);
        servletRegistrationBean.addInitParameter("resetEnable", this.statViewServletResetEnable);
    ...
    public FilterRegistrationBean<WebStatFilter> filterRegistrationBean() {
        ...
        FilterRegistrationBean<WebStatFilter> filterRegistrationBean = new FilterRegistrationBean(webStatFilter, new ServletRegistrationBean[0]);
        filterRegistrationBean.addUrlPatterns(new String[]{"/*"});
        filterRegistrationBean.addInitParameter("exclusions", this.webStatFilterExclusions);
        ...
        if (o == this) {
            ...
            if (!other.canEqual(this)) {
                ...
                if (this.getInitialSize() != other.getInitialSize()) {
                    ...
                    } else if (!this$connectionProperties.equals(other$connectionProperties)) {
                        return false;
                    }

                    label124: {
                        Object this$webStatFilterExclusions = this.getWebStatFilterExclusions();
                        Object other$webStatFilterExclusions = other.getWebStatFilterExclusions();
                        if (this$webStatFilterExclusions == null) {
                            if (other$webStatFilterExclusions == null) {
                                break label124;
                            }
                        } else if (this$webStatFilterExclusions.equals(other$webStatFilterExclusions)) {
                            break label124;
                        }
                    ...
                    Object other$statViewServletMapping = other.getStatViewServletMapping();
                    if (this$statViewServletMapping == null) {
                        if (other$statViewServletMapping != null) {
                            return false;
                        }
                    } else if (!this$statViewServletMapping.equals(other$statViewServletMapping)) {
                        return false;
                    }

                    Object this$statViewServletLoginUsername = this.getStatViewServletLoginUsername();
                    Object other$statViewServletLoginUsername = other.getStatViewServletLoginUsername();
                    if (this$statViewServletLoginUsername == null) {
                        if (other$statViewServletLoginUsername != null) {
                            return false;
                        }
                    } else if (!this$statViewServletLoginUsername.equals(other$statViewServletLoginUsername)) {
                        return false;
                    }

                    label103: {
                        Object this$statViewServletLoginPassword = this.getStatViewServletLoginPassword();
                        Object other$statViewServletLoginPassword = other.getStatViewServletLoginPassword();
                        if (this$statViewServletLoginPassword == null) {
                            if (other$statViewServletLoginPassword == null) {
                                break label103;
                            }
                        } else if (this$statViewServletLoginPassword.equals(other$statViewServletLoginPassword)) {
                            break label103;
                        }
                    ...
                    Object this$statViewServletResetEnable = this.getStatViewServletResetEnable();
                    Object other$statViewServletResetEnable = other.getStatViewServletResetEnable();
                    if (this$statViewServletResetEnable == null) {
                        if (other$statViewServletResetEnable != null) {
                            return false;
                        }
                    } else if (!this$statViewServletResetEnable.equals(other$statViewServletResetEnable)) {
                        return false;
                    }
    ...
    public int hashCode() {
        ...
        result = result * 59 + ($webStatFilterExclusions == null ? 43 : $webStatFilterExclusions.hashCode());
        Object $statViewServletMapping = this.getStatViewServletMapping();
        result = result * 59 + ($statViewServletMapping == null ? 43 : $statViewServletMapping.hashCode());
        Object $statViewServletLoginUsername = this.getStatViewServletLoginUsername();
        result = result * 59 + ($statViewServletLoginUsername == null ? 43 : $statViewServletLoginUsername.hashCode());
        Object $statViewServletLoginPassword = this.getStatViewServletLoginPassword();
        result = result * 59 + ($statViewServletLoginPassword == null ? 43 : $statViewServletLoginPassword.hashCode());
        Object $statViewServletResetEnable = this.getStatViewServletResetEnable();
        result = result * 59 + ($statViewServletResetEnable == null ? 43 : $statViewServletResetEnable.hashCode());
        return result;
    }

    public String toString() {
        return "DruidConfiguration(url=" + this.getUrl() + ", username=" + this.getUsername() + ", driverClassName=" + this.getDriverClassName() + ", initialSize=" + this.getInitialSize() + ", minIdle=" + this.getMinIdle() + ", maxActive=" + this.getMaxActive() + ", maxWait=" + this.getMaxWait() + ", timeBetweenEvictionRunsMillis=" + this.getTimeBetweenEvictionRunsMillis() + ", minEvictableIdleTimeMillis=" + this.getMinEvictableIdleTimeMillis() + ", testWhileIdle=" + this.isTestWhileIdle() + ", testOnBorrow=" + this.isTestOnBorrow() + ", testOnReturn=" + this.isTestOnReturn() + ", poolPreparedStatements=" + this.isPoolPreparedStatements() + ", maxPoolPreparedStatementPerConnectionSize=" + this.getMaxPoolPreparedStatementPerConnectionSize() + ", filters=" + this.getFilters() + ", connectionProperties=" + this.getConnectionProperties() + ", webStatFilterExclusions=" + this.getWebStatFilterExclusions() + ", statViewServletMapping=" + this.getStatViewServletMapping() + ", statViewServletLoginUsername=" + this.getStatViewServletLoginUsername() + ", statViewServletLoginPassword=" + this.getStatViewServletLoginPassword() + ", statViewServletResetEnable=" + this.getStatViewServletResetEnable() + ")";
    }
}
