...
import com.sunflower.framework.amqp.listener.DeadLetterMessageListener;
...
/**
 * <p>
 * <b>Description:</b> RabbitMQ交换机、队列的配置类.定义交换机、key、queue并做好绑定。 同时定义每个队列的ttl，队列最大长度，Qos等等
